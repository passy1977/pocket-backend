...
CREATE DATABASE IF NOT EXISTS pocket5 CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
CREATE USER IF NOT EXISTS 'pocket5'@'%' IDENTIFIED BY 'MARIADB_ROOT_PWD';
GRANT ALL PRIVILEGES ON pocket5.* TO 'pocket5'@'%';
FLUSH PRIVILEGES;
